...
<body>
	...
	<div class="container">
		...
		<table class="table" >
			<thead>
				<tr>
					<th onclick="sort('productId')" style="cursor:default;" class="col-md-1 col-1 text-center">商品编号</th>
					<th onclick="sort('productName')" style="cursor:default;" class="col-md-1 col-1 text-center">商品名称</th>
					<th onclick="sort('productPrice')" style="cursor:default;" class="col-md-1 col-1 text-center">单价</th>
					<th class="col-md-2 col-2 text-center">描述</th>
					<th class="col-md-3 col-3 text-center">图片</th>
					<th class="col-md-1 col-1 text-center">类别</th>
					<th class="col-md-1 col-1 text-center">所剩份额</th>
					<th class="col-md-1 col-1 text-center">操作</th>
					<th class="col-md-1 col-1 text-center">选择</th>
				</tr>
			</thead>
			<tbody>
				<c:choose>
					...
					<c:otherwise>
						<c:forEach items="${pageInfo.content}" var="product">
							<tr>
								<td class="col-md-1 col-1 text-center">${product.productId}</td>
								<!-- 使用c:out解决页面上的服务式攻击问题 -->
								<td class="col-md-1 col-1 text-center"><c:out value="${product.productName}" escapeXml="true"></c:out></td>
								<td class="col-md-1 col-1 text-center">${product.productPrice}</td>
								<td class="col-md-2 col-2 text-center">
									<c:out value="${product.productDescription}" escapeXml="true"></c:out>
								</td >
								<td style="height: 160px" class="col-md-3 col-3 text-center">
								...
								<td class="col-md-1 col-1 text-center">${product.productStock }</td>
								<td class="col-md-1 col-1 text-center">
								...
								<td class="col-md-1 col-1 text-center"><input type="checkbox" name="selDel" title="选中" value="${product.productId}"></td>
							</tr>
						</c:forEach>
					</c:otherwise>
				</c:choose>
