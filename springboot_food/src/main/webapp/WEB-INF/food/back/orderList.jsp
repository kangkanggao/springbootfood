		...
		<table class="table" >
			<thead>
				<tr>
					...
					<th class="col-md-2 col-2 text-center">买家用户名</th>
					<th class="col-md-1 col-1 text-center">买家电话</th>
					<th class="col-md-2 col-2 text-center">买家地址</th>
					<th class="col-md-1 col-1 text-center">订单状态</th>
					<th class="col-md-1 col-1 text-center">支付状态</th>
					<th class="col-md-1 col-1 text-center">创建时间</th>
					<th class="col-md-1 col-1 text-center">更新时间</th>
					<th class="col-md-1 col-1 text-center">总金额</th>
					<th class="col-md-1 col-1 text-center">订单内容</th>
				</tr>
			</thead>
			<tbody >
				<c:choose>
					...
					<c:otherwise>
						<c:forEach items="${pageInfo.content}" var="order">
							...
							<tr>
								<td class="col-md-1 col-1 text-center">${order.orderId}</td>
								<td class="col-md-2 col-2 text-center">${order.buyerName}</td>
								<td class="col-md-1 col-1 text-center">${order.buyerPhone}</td>
								...
								<td class="col-md-1 col-1 text-center">${order.createTime}</td>
								<td class="col-md-1 col-1 text-center">${order.updateTime}</td>
								<td class="col-md-1 col-1 text-center">${order.orderAmount}</td>
								<td class="col-md-1 col-1 text-center">
