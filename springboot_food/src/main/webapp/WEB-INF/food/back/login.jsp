...
<body>
	...
	<div class="container-fluid" style="width: 40%; padding: 50px; border: solid, black, 1px; background-image: url(resources/image/2.jpg); background-size: 100%;">
		<div class="row">
			<div class="col-md-12">
				<c:if test="${msg!=null }">
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" id="inputName"
								placeholder="用户名" name="username" value="${param.name}">
						</div>
					</div>
					<div class="form-group row">
