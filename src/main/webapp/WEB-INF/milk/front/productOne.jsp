	...
	<div class="container-fluid mx-auto">
		...
		<div class="row mx-auto " style="width: 80%">
			...
			<div class="row mx-auto text-center"
				style="border: 1px solid red; width: 93%; height: 100px;background-color: rgb(0, 137, 220); margin-bottom: 20px">
				<div
				...
				<div
					...
					<h3 class="text-left" style="color: white;"></h3>
					...
					<c:choose>
						...
						<c:otherwise>
							<c:forEach items="${pageInfo.content}" var="productInfo">
								...
								<div class="col-md-4" style="padding-left:0px;padding-right:0px;margin-bottom: 1px;border: 1px solid red;">
									<div class="card-group">
										<div class="card" >
											<img class="card-img-top img-thumbnail "
