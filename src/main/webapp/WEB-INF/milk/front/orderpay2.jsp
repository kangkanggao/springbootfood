		...
		<div class="top center">
			<div class="left fl">
				<ul>
					...
					<li>|</li>
					<li><a href="<%=basePath %>front/toMain">移动版</a></li>
					<li>|</li>
...
<body>
	<div class="container-fluid">
		...
		<div class="row mx-auto text-center"
			style="border: 1px solid #424242; width: 90%; height: 20%; background-color: #ff6700; margin-bottom: 0px">
			<div
		...
		<div class="row mx-auto" style="width: 80%;">
			...
			<div class="col-md-12">
				<div class="row">
					<!-- 中间左边部分 -->
					<div class="col-md-5"
						style="border: 2px solid #ff6700; width: 90%; height: 100%">
						<div class="col-md-12">
							<table class="table table-hover">
								...
								<thead class="col-md-12">
									...
									<tr class="row" style="background: #FFFFCC">
										<!-- 设置每一列宽 -->
										<th class=" col-md-6 col-1 text-center">商品</th>
								...
								<tfoot>
								  <!-- 分割线 -->
										...
										<hr style="color: #987cb9; size: 2px; width: 100%">
										<div class="mx-auto"
											style="width: 90%; border: 1px solid #ff6700;">
											<ul
						...
						<div
							style="border: 1px solid #ff6700;; margin-left: 50%; background-color: #ff6700"
							class=" col-md-6">
					...
					<!-- 中间左边部分end -->
					<!-- 中间右边部分 -->
					<div class="col-md-7 " style="border: 2px solid #ff6700; width: 90%;">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="row mx-auto" style="width: 100%">
										...
										<hr style="color: #ff6700; size: 2px; width: 100%;">
										<!-- 地址选择 -->
