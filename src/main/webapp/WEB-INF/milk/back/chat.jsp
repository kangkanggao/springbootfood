...
<body>
			...
			<div class="abs cover pnl-body" id="pnlBody">
				<div class="abs cover pnl-left">
					<div class="abs cover pnl-msgs scroll" id="show">
						...
						<div class="pnl-list" id="msgs">
							<div class="msg robot">
								<div class="msg-left" worker="用户">
									<div class="msg-host photo"
										style="background-image: url(../Images/head.png)"></div>
									<div class="msg-ball" id="seller_date" title="今天 17:52:06"
										id="seller_id">你好</div>
								</div>
							</div>
							<input hidden="hidden" type="text" name="toUser" id="sendUser"
								value="${sessionScope.seller.username}" /><br /> <input
								type="text" name="sendUser" hidden="hidden" id="toUser"
					...
					<div class="abs bottom pnl-text">
						...
						<div class="abs br pnl-btn" id="submit"
							...
							onclick="send()">发送</div>
						<div class="pnl-support" id="copyright"></div>
					</div>
				</div>
				<div class="abs right pnl-right">
					...
					<div class="pnl-right-content">
						<div class="pnl-tabs">
							<div class="tab-btn active" id="hot-tab">
								<a href="front/productInfoList">买家列表</a><br>
								<ul id="userid">
	...
	<script type="text/javascript">
	  function selectUser(e){
		  alert($(e).text());
      	document.getElementById('toUser').value=$(e).text();
	        }
	    var websocket = null;
	    	...
	    	　		if(${empty buyer.buyerName }){
	 			...
	 			//连接发生错误的回调方法
	 	          ...
	 	          websocket.onmessage = function(event){
	 	        		 ...
	 	        		 // document.getElementById('count').innerHTML=data[1];
	 	        	  }else if(event.data.indexOf("users")>-1){
	 	        		  var msg = event.data;
	 	        		  ...
	 	        		  if(username!=sendUser){ 
	 	        			 var elem_li = document.createElement('li'); // 生成一个 li元素
		 	        	        elem_li.innerHTML = username; // 设置元素的内容
		 	        	        elem_li.setAttribute("onClick", "selectUser(this)");
		 	        	        elem_li.setAttribute("id",username);
		 	        	        document.getElementById('userid').appendChild(elem_li); // 添加到UL中去
