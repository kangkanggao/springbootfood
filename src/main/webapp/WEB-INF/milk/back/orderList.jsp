...
<%-- 	<%@include file="common/nav.jsp" %> --%>
	...
	<div class="container">
		<!-- 订单管理界面 -->
		<div>
			<h4 class="border-bottom" style="line-height: 40px;">订单管理</h4>
		</div>
		<div class="col-md">
			<div class="row">
				<div class="col-md-12">
					<form action="back/totoOrderList" id="toOrderListForm" >
							...
							<c:if test="${not empty pageInfo.content }">
								<ul class="pagination">
									<c:choose>
										...
										<c:otherwise>
											<li class="page-item">
												<a href="back/toOrderList?pageNo=${pageInfo.number+1-1 }" class="page-link">&laquo;</a>
											</li>
										</c:otherwise>
									</c:choose>
									<c:choose>
										<c:when test="${pageInfo.totalPages<=5 }">
											<c:forEach begin="1" end="${pageInfo.totalPages }" var="i">
												<li class="page-item">
													<a href="back/toOrderList?pageNo=${i }" class="page-link">${i }</a>
												</li>
											</c:forEach>
										</c:when>
										<c:when test="${pageInfo.number+1<=3 }">
											<li class="page-item"><a href="back/toOrderList?pageNo=1" class="page-link">1</a></li>
											<li class="page-item"><a href="back/toOrderList?pageNo=2" class="page-link">2</a></li>
											<li class="page-item"><a href="back/toOrderList?pageNo=3" class="page-link">3</a></li>
											<li class="page-item"><a href="back/toOrderList?pageNo=4" class="page-link">4</a></li>
											<li class="page-item"><a href="back/toOrderList?pageNo=${pageInfo.totalPages }" class="page-link">..${pageInfo.totalPages }</a></li>
										</c:when>
										<c:when test="${pageInfo.number+1>=pageInfo.totalPages-2 }">
											<li class="page-item"><a href="back/toOrderList?pageNo=1" class="page-link">1..</a></li>
											<li class="page-item"><a href="back/toOrderList?pageNo=${pageInfo.totalPages-3 }" class="page-link">${pageInfo.totalPages-3 }</a></li>
											<li class="page-item"><a href="back/toOrderList?pageNo=${pageInfo.totalPages-2 }" class="page-link">${pageInfo.totalPages-2 }</a></li>
											<li class="page-item"><a href="back/toOrderList?pageNo=${pageInfo.totalPages-1 }" class="page-link">${pageInfo.totalPages-1 }</a></li>
											<li class="page-item"><a href="back/toOrderList?pageNo=${pageInfo.totalPages }" class="page-link">${pageInfo.totalPages }</a></li>
										</c:when>
										<c:otherwise>
											<li class="page-item"><a href="back/toOrderList?pageNo=1" class="page-link">1..</a></li>
											<li class="page-item"><a href="back/toOrderList?pageNo=${pageInfo.number+1-1 }" class="page-link">${pageInfo.number+1-1 }</a></li>
											<li class="page-item"><a href="back/toOrderList?pageNo=${pageInfo.number+1 }" class="page-link">${pageInfo.number+1 }</a></li>
											<li class="page-item"><a href="back/toOrderList?pageNo=${pageInfo.number+1+1 }" class="page-link">${pageInfo.number+1+1 }</a></li>
											<li class="page-item"><a href="back/toOrderList?pageNo=${pageInfo.totalPages }" class="page-link">..${pageInfo.totalPages }</a></li>
										</c:otherwise>
									</c:choose>
									<c:choose>
										...
										<c:otherwise>
											<li class="page-item"><a
												href="back/toOrderList?pageNo=${pageInfo.number+1+1 }" class="page-link">&raquo;</a></li>
										</c:otherwise>
									</c:choose>
								</ul>
							</c:if>
