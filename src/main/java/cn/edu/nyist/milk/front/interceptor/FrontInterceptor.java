package cn.edu.nyist.milk.front.interceptor;
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object arg2) throws Exception {
		...
		if(requestURI.contains("/front")) {
			if (request.getSession().getAttribute("buyer") == null) {
				if (requestURI.endsWith("/toLogin") || requestURI.endsWith("/login")|| requestURI.endsWith("/sendSMS")  ||requestURI.endsWith("/toReg")||requestURI.endsWith("/reg")|| requestURI.endsWith("/vcode.png")) {
					return true;
				}
